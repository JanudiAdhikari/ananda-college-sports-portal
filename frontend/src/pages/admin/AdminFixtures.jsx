        ...
        <div className="mb-6 flex flex-col gap-4">
          ...
          <div className="grid gap-3 grid-cols-1 sm:grid-cols-4">
            ...
            <input
              ...
              className="w-full rounded-xl border border-ananda-gold/25 bg-white px-3 py-2.5 text-xs font-semibold outline-none focus:border-ananda-maroon focus:ring-1 focus:ring-ananda-maroon transition shadow-sm"
            />
                ...
                >
                  <div className="mb-4 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-gray-505 flex items-center gap-1.5">
                        <svg className="h-3.5 w-3.5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">

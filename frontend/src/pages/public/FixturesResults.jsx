              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4 flex items-center justify-between gap-4">
                    <p className="font-display text-xs font-semibold tracking-[0.2em] text-ananda-gold">
                      {fixture.sport?.name}
                    </p>

                    <span className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-bold  tracking-wider ${statusStyles[fixture.status] ||"bg-gray-100 text-gray-600"}`}>
                  ...
                  {/* Title & Match details */}
                  <h2 className="font-display text-xl font-bold tracking-tight text-ananda-dark-maroon mb-2">
                    {fixture.title}
                  </h2>
                  ...
                  {/* Date and Venue */}
                  <div className="mt-3 space-y-1.5 text-xs text-gray-500 font-medium tracking-wider border-b border-ananda-gold/10 pb-4">
                  ...
                  {(fixture.status ==="COMPLETED" || fixture.status ==="LIVE" || fixture.result?.anandaScore !== undefined || fixture.result?.opponentScore !== undefined) && (
                    <div className="mt-4 grid gap-4 grid-cols-2">
                      <div className="rounded-xl border border-ananda-gold/10 bg-ananda-cream/35 p-3 text-center">
                        <p className="text-[10px] font-bold tracking-wider text-gray-400">Ananda College</p>
                      ...
                      <div className="rounded-xl border border-ananda-gold/10 bg-ananda-cream/35 p-3 text-center">
                        <p className="text-[10px] font-bold tracking-wider text-gray-400 truncate">{fixture.opponent}</p>
                        <p className="font-display mt-1 text-2xl font-bold text-ananda-maroon">
                  ...
                  {fixture.result?.resultText && (
                    <div className="font-display mt-4 rounded-xl bg-ananda-light-gold/65 border border-ananda-gold/20 px-4 py-2.5 text-xs font-bold tracking-wider text-ananda-dark-maroon text-center">
                      {fixture.result.resultText}
                    </div>
                  )}

              ...
              <div className="rounded-2xl border border-ananda-gold/15 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-bold tracking-wider text-gray-400">Head Coach</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-bold tracking-wider text-gray-400">Assistant Coach</p>
              ...
              <div className="rounded-2xl border border-ananda-gold/15 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-bold tracking-wider text-gray-400">Captain</p>
                      {team.captain ? (
                        <Link
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-bold tracking-wider text-gray-400">Vice Captain</p>
                      {team.viceCaptain ? (
                        <Link
          ...
          <div className="lg:col-span-8">
            ...
            {loadingPlayers && (
              <div className="flex flex-col items-center gap-4 py-12 text-center">
                ...
                <p className="font-display text-sm tracking-wide text-ananda-maroon">
                  Loading roster...
                </p>
              </div>
            )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute top-3 right-3 flex flex-col gap-1 items-end">
                        ...
                        {isCaptain && (
                          <span className="bg-ananda-maroon text-white text-[9px] font-bold tracking-wider px-2 py-0.5 rounded-full">
                            Captain
                          </span>
                        )}
                        {isViceCaptain && (
                          <span className="bg-ananda-gold text-ananda-dark-maroon text-[9px] font-bold tracking-wider px-2 py-0.5 rounded-full">
                            Vice Captain
                          </span>
                        )}
                      </div>
                      ...
                      {/* Role */}
                      <p className="text-xs font-medium text-gray-500 tracking-wider mt-1">
